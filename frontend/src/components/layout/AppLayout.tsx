...
const fireEquipmentNavItems = [
  ...
  { label: 'Alarm Buton', icon: ChevronRight, to: '/fire-equipment/list?category=Alarm Buton' },
  ...
  { label: 'Otm. Gazlı Söndürme', icon: ChevronRight, to: '/fire-equipment/list?category=Otomatik Gazlı Söndürme Sistemi' },
