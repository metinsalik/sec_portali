          ...
          contentDocument.write(`
            <html>
              <head>
                ${headHtml}
                <style>
                  @page { size: ${size === 'A5' ? 'A5' : 'A4'} portrait; margin: 0; }
        ...
        <div className="flex-1 min-h-0 flex gap-6 overflow-hidden pt-4 border-t">
          <div className="w-64 flex flex-col gap-6 shrink-0 overflow-y-auto">
            <div className="space-y-3">
              ...
              <Select value={size} onValueChange={(v: 'A4' | 'A5') => setSize(v)}>
              ...
              <p className="text-xs text-slate-500">
                A5 boyutu, üretim sahasında makine üzerlerine veya panolara asmak için idealdir.
              </p>
            </div>
          ...
          <div className="flex-1 bg-slate-100 rounded-xl border border-slate-200 overflow-auto flex items-start justify-center p-8 relative custom-scrollbar">
            <div className="origin-top" style={{ transform: 'scale(0.65)', transformOrigin: 'top center', marginBottom: '-35%' }}>
