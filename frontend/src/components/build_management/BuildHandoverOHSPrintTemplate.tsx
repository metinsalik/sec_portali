...
export const BuildHandoverOHSPrintTemplate = forwardRef<HTMLDivElement, Props>(
  ({ project, inspection }, ref) => {
    const formCode = "FRM-İSG-TSL-01";
            ...
            <tr className="no-border">
              <td>
                <div className="title-box">
                  ...
                  İSG TESLİM ALMA KONTROL LİSTESİ
                </div>
...
BuildHandoverOHSPrintTemplate.displayName = 'BuildHandoverOHSPrintTemplate';
