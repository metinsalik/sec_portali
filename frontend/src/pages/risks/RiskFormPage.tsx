  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Sol 2 Kolon: Form İçeriği */}
        <div className="lg:col-span-2 space-y-6">
          {/* Bölüm 1: Genel Bilgiler */}
          <Card className="shadow-sm border-muted">
            <CardHeader className="pb-3">
              <CardTitle className="text-base font-bold text-foreground">1. Genel Risk Bilgileri</CardTitle>
              <CardDescription>Riskin tespit edildiği tarih, kategori ve kapsamı</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateField('detectionDate', e.target.value)}
                    required
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <Input
                    type="number"
                    value={form.riskNo}
                    onChange={(e) => updateField('riskNo', e.target.value)}
                    placeholder="Örn: 1"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full h-9 rounded-md border border-input bg-background px-3 text-sm focus:outline-none focus:ring-2 focus:ring-ring"
                    disabled={!form.riskCategory}
                  >
                    <option value="">Seçiniz...</option>
                    {subCategoryOptions.map((sc: any) => (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-muted-foreground">Alan / Bölüm *</label>
                  <select
                    value={form.area}
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    placeholder="Örn: Kimyasal atıkların taşınması"
                  />
                </div>
              </div>

              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-muted-foreground">Tehlike / Tehlike Kaynağı *</label>
                <Input
                  value={form.hazard}
                  onChange={(e) => updateField('hazard', e.target.value)}
                  placeholder="Örn: Koruyucu eldiven kullanılmaması"
                />
              </div>

              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-muted-foreground">Risk (Olası Tehlikeli Olay) *</label>
                <Textarea
                  value={form.riskDescription}
                  onChange={(e) => updateField('riskDescription', e.target.value)}
                  placeholder="Örn: Kimyasalın cilde teması sonucu kimyasal yanık oluşması"
                  rows={2}
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <Input
                    value={form.impactDamage}
                    onChange={(e) => updateField('impactDamage', e.target.value)}
                    placeholder="Örn: Yaralanma, İş gücü kaybı, Tedavi masrafı"
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    placeholder="Örn: Hemşireler, Temizlik Personeli, Stajyerler"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <Textarea
                  ...
                  onChange={(e) => updateField('legislation', e.target.value)}
                  placeholder="Örn: 6331 Sayılı İSG Kanunu, Kimyasal Maddelerle Çalışmalarda Sağlık ve Güvenlik Önlemleri Hakkında Yönetmelik"
                  rows={2}
                />
              </div>
            </CardContent>
          ...
          <Card className="shadow-sm border-muted">
            <CardHeader className="pb-3">
              <CardTitle className="text-base font-bold text-foreground">2. Mevcut Durum Önlemleri & Görseli</CardTitle>
              <CardDescription>Riske karşı sahadaki mevcut durum ve varsa görseller</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-muted-foreground">
                  Mevcut Durum Açıklaması (Alınmış olan önlemler) *
                </label>
                <Textarea
                  value={form.initialCondition}
                  onChange={(e) => updateField('initialCondition', e.target.value)}
                  placeholder="Örn: Kişisel koruyucu donanım deposunda eldiven var fakat kullanım takibi yapılmıyor."
                  rows={2}
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap items-center gap-4 border p-3 rounded-lg bg-muted/20">
                  {form.initialImage ? (
                    <div className="relative group w-28 h-20 rounded-md overflow-hidden border">
                      ...
                      <a
                        href={form.initialImage}
                        target="_blank"
                        rel="noreferrer"
                        className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 flex items-center justify-center text-[10px] text-white transition-opacity font-medium"
                      >
                        Görüntüle
                      </a>
                    </div>
                  ...
                  <label className="flex items-center gap-1.5 cursor-pointer text-xs font-semibold text-muted-foreground hover:text-foreground border border-dashed rounded-md px-4 py-2 hover:border-foreground/40 transition-colors bg-background">
                    ...
                    <input
                      ...
                      className="hidden"
                      onChange={(e) => {
                        if (e.target.files?.[0]) uploadImage('initialImage', e.target.files[0]);
                      }}
                    />
                  </label>
                </div>
          ...
          {/* Bölüm 3: İyileştirme Planı */}
          <Card className="shadow-sm border-muted">
            <CardHeader className="pb-3">
              <CardTitle className="text-base font-bold text-foreground">3. İyileştirme Planı / Uygulama</CardTitle>
              <CardDescription>Riske yönelik planlanan veya yapılan iyileştirme adımları</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-muted-foreground">
                ...
                <Textarea
                  ...
                  placeholder="Örn: Bölüm çalışanlarına koruyucu donanım eğitimi verildi, denetim formu oluşturuldu."
                  rows={2}
                />
              </div>
                  ...
                  <div className="flex items-center gap-3">
                    {form.actionImage ? (
                      <div className="relative group w-20 h-10 rounded border overflow-hidden shrink-0">
                        ...
                        <a
                          href={form.actionImage}
                          target="_blank"
                          rel="noreferrer"
                          className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 flex items-center justify-center text-[8px] text-white transition-opacity"
                        >
                          Görüntüle
                        </a>
                      </div>
                    ...
                    <label className="flex items-center gap-1.5 cursor-pointer text-xs font-semibold text-muted-foreground hover:text-foreground border border-dashed rounded px-3 py-1.5 hover:border-foreground/40 transition-colors bg-background">
                      ...
                      <input
                        ...
                        className="hidden"
                        onChange={(e) => {
                          if (e.target.files?.[0]) uploadImage('actionImage', e.target.files[0]);
                        }}
                      />
                    </label>
                  </div>
          ...
          {/* Bölüm 4: Etkinlik Ölçümü */}
          <Card className="shadow-sm border-muted">
            <CardHeader className="pb-3">
              <CardTitle className="text-base font-bold text-foreground">4. İyileştirme Etkinlik Ölçümü</CardTitle>
              <CardDescription>İyileştirmelerin doğrulanması ve kontrol süreci</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateField('effectivenessMethod', e.target.value)}
                    placeholder="Örn: 30 gün boyunca haftalık saha denetimleri"
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    onChange={(e) => updateField('controlResponsible', e.target.value)}
                    className="w-full h-9 rounded-md border border-input bg-background px-3 text-sm focus:outline-none focus:ring-2 focus:ring-ring"
                  >
                    <option value="">Seçiniz...</option>
                    {settingsDepartments.map((dept: any) => (
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-muted-foreground">Sonuç / Değerlendirme</label>
                <Textarea
                  value={form.controlResult}
                  onChange={(e) => updateField('controlResult', e.target.value)}
                  placeholder="Örn: Yapılan 4 denetimde de eldiven kullanımının %100 oranında sürdüğü gözlendi."
                  rows={2}
                />
              </div>
            </CardContent>
        ...
        {/* Sağ Kolon: Risk Skor Kartları */}
        <div className="space-y-6">
          {/* Kart 1: MEVCUT RİSK SKORU */}
          <Card className={`shadow-sm border transition-all duration-300 ${initialLevelInfo.card}`}>
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <CardTitle className="text-base font-bold text-foreground">Mevcut Risk Skoru</CardTitle>
                <Badge variant="outline" className={`font-semibold ${initialLevelInfo.badge}`}>
                  {initialLevelInfo.label}
                </Badge>
              </div>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                ...
                <select
                  value={form.initialProb}
                  onChange={(e) => handleScoreInput('initialProb', e.target.value)}
                  className="w-full h-9 rounded-md border border-input bg-background px-3 text-sm focus:outline-none focus:ring-2 focus:ring-ring"
                >
                  <option value="">Seçiniz...</option>
              ...
              <div className="space-y-1.5">
                ...
                <select
                  value={form.initialFreq}
                  onChange={(e) => handleScoreInput('initialFreq', e.target.value)}
                  className="w-full h-9 rounded-md border border-input bg-background px-3 text-sm focus:outline-none focus:ring-2 focus:ring-ring"
                >
                  <option value="">Seçiniz...</option>
              ...
              <div className="space-y-1.5">
                ...
                <select
                  value={form.initialSev}
                  onChange={(e) => handleScoreInput('initialSev', e.target.value)}
                  className="w-full h-9 rounded-md border border-input bg-background px-3 text-sm focus:outline-none focus:ring-2 focus:ring-ring"
                >
                  <option value="">Seçiniz...</option>
              ...
              <div className="flex items-center justify-between border-t pt-4">
                <span className="text-sm font-semibold text-muted-foreground">Hesaplanan Puan:</span>
                <span className="text-3xl font-extrabold tracking-tight">{form.initialScore || '0'}</span>
              </div>
              ...
              <div className="border-t pt-4 space-y-3">
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    onChange={(e) => updateField('improvementResponsible', e.target.value)}
                    className="w-full h-9 rounded-md border border-input bg-background px-3 text-sm focus:outline-none focus:ring-2 focus:ring-ring"
                  >
                    <option value="">Seçiniz...</option>
                    {settingsDepartments.map((dept: any) => (
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-muted-foreground">Termin *</label>
                  <Input
                    type="date"
                    value={form.dueDate}
          ...
          {/* Kart 2: İYİLEŞTİRME SONRASI RİSK SKORU */}
          <Card className={`shadow-sm border transition-all duration-300 ${finalLevelInfo.card}`}>
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <CardTitle className="text-base font-bold text-foreground">İyileştirme Sonrası Risk Skoru</CardTitle>
                <Badge variant="outline" className={`font-semibold ${finalLevelInfo.badge}`}>
                  {finalLevelInfo.label}
                </Badge>
              </div>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                ...
                <select
                  value={form.finalProb}
                  onChange={(e) => handleScoreInput('finalProb', e.target.value)}
                  className="w-full h-9 rounded-md border border-input bg-background px-3 text-sm focus:outline-none focus:ring-2 focus:ring-ring"
                >
                  <option value="">Seçiniz...</option>
                  {PROBABILITY_OPTIONS.map((o) => (
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-muted-foreground">Frekans (F)</label>
                <select
                  value={form.finalFreq}
                  onChange={(e) => handleScoreInput('finalFreq', e.target.value)}
                  className="w-full h-9 rounded-md border border-input bg-background px-3 text-sm focus:outline-none focus:ring-2 focus:ring-ring"
                >
                  <option value="">Seçiniz...</option>
                  {FREQUENCY_OPTIONS.map((o) => (
              ...
              <div className="space-y-1.5">
                ...
                <select
                  value={form.finalSev}
                  onChange={(e) => handleScoreInput('finalSev', e.target.value)}
                  className="w-full h-9 rounded-md border border-input bg-background px-3 text-sm focus:outline-none focus:ring-2 focus:ring-ring"
                >
                  <option value="">Seçiniz...</option>
                  {SEVERITY_OPTIONS.map((o) => (
              ...
              <div className="border-t pt-4 space-y-3">
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-muted-foreground">İyileştirme Sorumlusu</label>
                  <select
                    value={form.postImprovementResponsible}
                    onChange={(e) => updateField('postImprovementResponsible', e.target.value)}
                    className="w-full h-9 rounded-md border border-input bg-background px-3 text-sm focus:outline-none focus:ring-2 focus:ring-ring"
                  >
                    <option value="">Seçiniz...</option>
                    {settingsDepartments.map((dept: any) => (
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    type="date"
                    value={form.postImprovementDueDate}
                    onChange={(e) => updateField('postImprovementDueDate', e.target.value)}
                  />
                </div>
              </div>
            </CardContent>
          ...
          {/* Kart 3: Durum Bilgilendirmesi */}
          <Card className="shadow-sm border-muted bg-muted/10">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-bold text-foreground">Risk Seviye Kriterleri</CardTitle>
            </CardHeader>
            <CardContent className="space-y-2 text-xs">
              <div className="flex items-center justify-between">
                <span className="font-semibold text-red-800 dark:text-red-400">R &gt; 400</span>
                <span>Tolere Gösterilmez Risk</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="font-semibold text-red-600 dark:text-red-400">200 &lt; R &le; 400</span>
                <span>Yüksek Risk</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="font-semibold text-orange-600 dark:text-orange-400">70 &lt; R &le; 200</span>
                <span>Önemli Risk</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="font-semibold text-yellow-600 dark:text-yellow-400">20 &lt; R &le; 70</span>
                <span>Olası Risk</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="font-semibold text-emerald-600 dark:text-emerald-400">0.1 &lt; R &le; 20</span>
                <span>Önemsiz Risk</span>
              </div>
            </CardContent>
          </Card>
        </div>
