  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        />
        <Card className="relative overflow-hidden cursor-pointer hover:shadow-md transition-all border-border bg-card group" onClick={() => setActiveDialog('certs')}>
...
function FinancialCard({ title, value, icon: Icon, color, description }: any) {
  // Using Shadcn variables instead of arbitrary Tailwind colors for consistency
  return (
