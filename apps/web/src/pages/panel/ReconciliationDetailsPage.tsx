...
export default function ReconciliationDetailsPage() {
  ...
  if (isLoading) {
    return <div className="space-y-6 animate-pulse"><div className="h-40 bg-muted rounded-lg" /><div className="h-64 bg-muted rounded-lg" /></div>;
  }
              ...
              {isMonthExpanded && (
                <div className="p-4 space-y-6 bg-muted/5 animate-in slide-in-from-top-2">
                  {facilityItems.map((fItem) => (
                    <div key={fItem.id} className="bg-background rounded-lg border shadow-sm overflow-hidden border-primary/5">
