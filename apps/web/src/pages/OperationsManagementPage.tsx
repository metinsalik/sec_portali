    ...
    <div className="min-h-screen flex flex-col font-sans bg-[#f8f9ff] dark:bg-[#171c20] bg-[radial-gradient(#d3e4fe_1px,transparent_1px)] dark:bg-[radial-gradient(#2c3135_1px,transparent_1px)] bg-[size:32px_32px] text-[#171c20] dark:text-[#edf1f6] transition-colors duration-300">
      ...
      <main className="flex-grow w-full max-w-[1440px] mx-auto px-4 md:px-6 py-8 md:py-10 flex flex-col pb-36 md:pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Card 3: Yangın Güvenliği Kontrol Sistemi */}
          {(hasAdminAccess || user?.modules?.includes('FIRE_SAFETY_CONTROL')) && (
            <div
              onClick={() => navigate('/fire-safety-control')}
              className="group bg-white dark:bg-[#2c3135] border border-slate-200/80 dark:border-[#73787c]/30 rounded-xl p-6 md:p-8 form-shadow hover:translate-y-[-4px] transition-all duration-300 flex flex-col justify-between cursor-pointer active:scale-98"
            >
              <div className="flex md:hidden items-start gap-4">
                <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-[#fff1f0] dark:bg-[#e03131]/20 flex items-center justify-center text-[#e03131] dark:text-red-400">
                  <span className="material-symbols-outlined text-[28px]">local_fire_department</span>
                </div>
                <div className="flex-1">
                  <h2 className="text-lg font-bold text-[#171c20] dark:text-[#edf1f6] mb-1">Yangın Güvenliği Kontrol Sistemi</h2>
                  <p className="text-sm text-[#42474b] dark:text-[#949899] mb-4">
                    Saha tespitleri, itfaiye ve denetim raporları, termin ve aksiyon takibi, kanıt yönetimi.
                  </p>
                  <div className="flex items-center gap-2 text-[#e03131] dark:text-red-400 text-sm font-medium group-hover:underline">
                    Uygulamaya Git
                    <span className="material-symbols-outlined text-[18px]">arrow_forward</span>
                  </div>
                </div>
              ...
              <div className="hidden md:flex flex-col justify-between h-full">
                <div>
                  <div className="w-14 h-14 rounded-xl bg-red-50 dark:bg-red-950/20 flex items-center justify-center mb-6 text-[#e03131] dark:text-red-400 transition-transform group-hover:scale-110">
                    <span className="material-symbols-outlined text-[32px]">local_fire_department</span>
                  </div>
                  <h3 className="text-xl font-bold text-[#011d2b] dark:text-[#cbe6fa] mb-2">Yangın Güvenliği Kontrol Sistemi</h3>
                  <p className="text-[#42474b] dark:text-[#949899] text-base mb-8 leading-relaxed">
                    Saha tespitleri, itfaiye ve denetim raporları, termin ve aksiyon takibi, kanıt yönetimi.
                  </p>
                </div>
                <div className="inline-flex items-center gap-2 text-[#e03131] dark:text-red-400 text-sm font-medium group-hover:gap-4 transition-all">
                  Uygulamaya Git
                  <span className="material-symbols-outlined text-[18px]">arrow_forward</span>
                </div>
              </div>
