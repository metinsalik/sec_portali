      ...
      <main className="flex-grow w-full max-w-[1440px] mx-auto px-4 md:px-6 py-8 md:py-10 flex flex-col pb-36 md:pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            {/* Mobile Card Layout */}
            <div className="flex md:hidden items-start gap-4">
              <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-amber-50 dark:bg-amber-950/20 flex items-center justify-center text-amber-600 dark:text-amber-400">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 text-amber-600 dark:text-amber-400 text-sm font-medium group-hover:underline">
                  Uygulamaya Git
                  <span className="material-symbols-outlined text-[18px]">arrow_forward</span>
                </div>
              </div>
            ...
            <div className="hidden md:flex flex-col justify-between h-full">
              <div>
                ...
                <p className="text-[#42474b] dark:text-[#949899] text-base mb-8 leading-relaxed">
                  Tesislerdeki ADP, jeneratör, kat panoları ve kritik altyapıların kontrol ve takip formu.
                </p>
              </div>
