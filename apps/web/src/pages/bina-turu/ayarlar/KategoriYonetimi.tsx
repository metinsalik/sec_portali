...
const KategoriYonetimi = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      const res = await api.get(`/bina-turu/ayarlar/kategori?facilityId=${facilityId}`);
  ...
  const handleSave = async () => {
    ...
    try {
      if (editId) {
        await api.put(`/bina-turu/ayarlar/kategori/${editId}`, { ad });
        toast.success('Kategori güncellendi.');
      } else {
        await api.post(`/bina-turu/ayarlar/kategori`, { facilityId, ad });
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      await api.delete(`/bina-turu/ayarlar/kategori/${id}`);
