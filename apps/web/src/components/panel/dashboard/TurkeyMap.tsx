  ...
  return (
    <Card className="lg:col-span-3 overflow-hidden border-primary/5 bg-gradient-to-br from-background to-muted/20">
      ...
      <CardContent className="p-4 sm:p-8">
        <div className="relative w-full min-h-[350px] flex items-center justify-center bg-white rounded-2xl border border-primary/10 p-4 group shadow-inner">
          <TooltipProvider>
            <TurkeyMap 
              customStyle={{ 
                idleColor: "#f1f5f9", 
                ...
                return (
                  <Tooltip key={cityDataProps.id}>
                    <TooltipTrigger asChild>
                      <g 
                        className="cursor-pointer transition-all duration-300 hover:brightness-90 outline-none"
                        onClick={() => onCityClick(cityDataProps.name)}
                      >
                    ...
                    <TooltipContent side="top" className="bg-popover/95 backdrop-blur-sm border-primary/20 shadow-2xl z-50">
                      <div className="text-sm p-1">
                        ...
                        {count > 0 && <p className="text-[10px] text-blue-600 mt-1 font-medium">İl detayları için tıklayın</p>}
                      </div>
                    </TooltipContent>
                  </Tooltip>
                );
          ...
          <div className="absolute bottom-6 right-8 bg-white/90 backdrop-blur-md p-4 rounded-2xl border border-primary/10 shadow-lg space-y-3 hidden md:block min-w-[140px] z-10">
