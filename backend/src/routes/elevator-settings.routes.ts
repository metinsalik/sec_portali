...
router.put('/maintenance-companies/:id', adminMiddleware, async (req, res) => {
  try {
    const { id } = req.params;
    const { name, facilityId } = req.body;
    const data: any = {};
...
router.put('/types/:id', adminMiddleware, async (req, res) => {
  try {
    const { id } = req.params;
    const { name, facilityId } = req.body;
    const data: any = {};
...
router.put('/statuses/:id', adminMiddleware, async (req, res) => {
  try {
    const { id } = req.params;
    const { name, facilityId } = req.body;
    const data: any = {};
...
router.put('/labels/:id', adminMiddleware, async (req, res) => {
  try {
    const { id } = req.params;
