...
const analiz_1 = __importDefault(require("./analiz"));
const rapor_1 = __importDefault(require("./rapor"));
const yillik_rapor_1 = __importDefault(require("./yillik-rapor"));
const uygunsuzluk_raporlari_1 = __importDefault(require("./uygunsuzluk-raporlari"));
...
router.use('/analiz', analiz_1.default);
router.use('/rapor', rapor_1.default);
router.use('/yillik-rapor', yillik_rapor_1.default);
router.use('/uygunsuzluk-raporlari', uygunsuzluk_raporlari_1.default);
