...
router.get('/', async (req, res) => {
    try {
        ...
        const criticalRiskDoorIds = new Set();
        inspectionItems.forEach(item => {
            ...
            let category = null;
            if (qTextLower.includes('kapan'))
                category = 'Kapanma Sistemi';
            else if (qTextLower.includes('conta') || qTextLower.includes('sızdırmaz'))
                category = 'İzolasyon (Conta)';
            else if (qTextLower.includes('menteşe'))
                category = 'Mekanik (Menteşe)';
            else if (qTextLower.includes('kilit'))
                category = 'Güvenlik (Kilit)';
            else if (qTextLower.includes('işaret') || qTextLower.includes('levha'))
                category = 'İşaretleme';
