...
router.delete('/brands/:id', auth_1.adminMiddleware, async (req, res) => {
    try {
        const { id } = req.params;
...
router.delete('/maintenance-companies/:id', auth_1.adminMiddleware, async (req, res) => {
    try {
        const { id } = req.params;
...
router.delete('/types/:id', auth_1.adminMiddleware, async (req, res) => {
    try {
        const { id } = req.params;
...
router.delete('/statuses/:id', auth_1.adminMiddleware, async (req, res) => {
    try {
        const { id } = req.params;
...
router.delete('/labels/:id', auth_1.adminMiddleware, async (req, res) => {
    try {
        const { id } = req.params;
